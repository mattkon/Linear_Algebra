...
print '\n','Given A in CSR format generate AT in the same format using minimum operations'
print 'AT = '
AT = transpose(A)
display_matrix(AT)
...
print 'MTX_B i, j, and data vectors: '
print 'i: ', i
print 'j: ', j
print 'data: ', data
print 'n: ', size
